...
<div class="row justify-content-center">
	<?php if ($lreports == 1){ ?>
	<a class="btn btn-success" href="lreports.php">التقارير</a>
	<?php } ?>
	<?php if ($lrok == 1){ ?>
	<a class="btn btn-success margin" href="lrok.php">اعتماد التقارير</a>
	<?php } ?>
	<?php if ($countc == 1){ ?>
	<a class="btn btn-success margin" href="countc.php">ادخال اعداد المهتدين</a>
	<?php } ?>
	<?php if ($portion == 1){ ?>
	<a class="btn btn-success margin" href="portion.php">ادخال نصيب الفرد</a>
	<?php } ?>
	<?php if ($expensesm == 1){ ?>
	<a class="btn btn-success margin" href="expensesm.php">ادخال مصروفات المراكز</a>
	<?php } ?>
	<?php if ($salary == 1){ ?>
	<a class="btn btn-success margin" href="salary.php">ادخال مسيرات الرواتب</a>
	<?php } ?>
</div>
</div>
</body>
