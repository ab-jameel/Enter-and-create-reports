...
<?php
$result=$conn->query("SELECT * FROM minfo WHERE m_year='$the_year' AND m_month='$the_month'") or die($conn->error());
?>
<div class="row justify-content-center">
	<table class="table cen1">
		...
		while ($row = $result->fetch_assoc()):
			 ...
			 ?>
			<tr class="me">
				<td class="rig1"><?php echo number_format($row['m_coss4']); ?></td>
				<td><?php echo number_format($row['m_coss3']); ?></td>
				<td class="rig1"><?php echo number_format($row['m_num3']); ?></td>
				<td><?php echo number_format($row['m_coss2']); ?></td>
				<td class="rig1"><?php echo number_format($row['m_num2']); ?></td>
				<td><?php echo number_format($row['m_coss1']); ?></td>
				<td class="rig1"><?php echo number_format($row['m_num1']); ?></td>
...
<div class="form-group">
	<br>
	<a href="minfo.php?edit=<?php echo $the_year; ?>&edit2=<?php echo $the_month; ?>&r=3" class="cancel">تعديل</a>
	<a href="money.php?y=<?php echo $the_year; ?>&m=<?php echo $the_month; ?>" class="cancel" target="_blank">طباعة</a>
