...
<?php
$result=$conn->query("SELECT * FROM expensesr WHERE r_year='$the_year' AND r_month='$the_month'") or die($conn->error());
?>
...
<div class="form-group">
	<br>
	<a href="expensesr.php?edit=<?php echo $the_year; ?>&edit2=<?php echo $the_month; ?>&r=3" class="cancel">تعديل</a>
	<a href="expensesr_report.php?y=<?php echo $the_year; ?>&m=<?php echo $the_month; ?>" class="cancel" target="_blank">طباعة</a>
