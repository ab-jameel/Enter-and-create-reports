...
<div class="row justify-content-center">
	<?php if ($creports == 1){ ?>
	<a class="btn btn-success" href="creports.php">التقارير</a>
	<?php } ?>
	<?php if ($crok == 1){ ?>
	<a class="btn btn-success margin" href="crok.php">اعتماد التقارير</a>
	<?php } ?>
	<?php if ($rprograms == 1){ ?>
	<a class="btn btn-success margin" href="rprograms.php">ادخال الحركة الميدانية</a>
	<?php } ?>
	<?php if ($minfo == 1){ ?>
	<a class="btn btn-success margin" href="minfo.php">ادخال المصروفات للدعوة</a>
	<?php } ?>
</div>
</div>
</body>
