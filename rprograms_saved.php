...
<?php
$result=$conn->query("SELECT * FROM rprograms WHERE b_year='$the_year' AND b_month='$the_month'") or die($conn->error());
?>
...
<div class="row justify-content-center">
	<table class="table">
		...
		while ($row = $result->fetch_assoc()){
				...
				$row1 = $result1->fetch_assoc(); ?>
			<tr class="me">
				<td class="cen2"><?php echo number_format($row['b_countt']); ?></td>
				<td class="cen2"><?php echo number_format($row['b_countk']); ?></td>
				<td class="cen2"><?php echo number_format($row['b_countm']); ?></td>
				<td class="cen2"><?php echo number_format($row['b_attend']); ?></td>
				<td class="cen2"><?php echo number_format($row['b_countr']); ?></td>
				<td class="cen2"><?php echo $row['b_place']; ?></td>
				<td class="right1"><?php echo $row1['group_name']; ?></td>
			</tr>
	<?php } ?>
	</table>
</div>
...
<div class="form-group">
	<br>
	<a href="rprograms.php?edit=<?php echo $the_year; ?>&edit2=<?php echo $the_month; ?>&r=3" class="cancel">تعديل</a>
	<a href="maidan.php?y=<?php echo $the_year; ?>&m=<?php echo $the_month; ?>" class="cancel" target="_blank">طباعة</a>
