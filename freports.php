...
if ($money == 1 and $freports == 1){

$result2 = $conn->query("SELECT premissions.*, pages.p_name FROM premissions INNER JOIN pages ON premissions.p_page = pages.ID WHERE p_user=$id AND premissions.p_manage = 3") or die($conn->error());
while ($row2 = $result2->fetch_assoc()) {
if ($row2['p_name'] == 'تقرير الايرادات والمصروفات'){
$expensesr = $row2['p_pdf'];
}
