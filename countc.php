...
<div class="row justify-content-center">
	<form action="php/countc_proccess.php" method="POST">
		<?php if (isset($_GET['edit'])) {
		}else{ ?>
		<div class="col col-sm-6">
		<div class="form-group">
			<label>: الشهر</label>
			<input type="hidden" name="c_month" value="<?php echo $the_month ?>">
		...
		<div class="form-group">
			<label>: العام </label>
			<input type="hidden" name="c_year" value="<?php echo $the_year ?>">
...
<div class="row justify-content-center">
	...
	$update = true;
	$r = $_GET['r'];
	$result=$conn->query("SELECT * FROM countc WHERE c_year='$id' AND c_month='$id2'") or die($conn->error());
...
<div class="row justify-content-center">
	<table class="table cen2">
		...
		while ($row = $result->fetch_assoc()):
			...
			<tr class="me">
				<?php $x = $t * 5;?>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_student1[]" value="<?php echo $row['c_student'] ?>" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_devl1[]" value="<?php echo $row['c_devl'] ?>" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_dev1[]" value="<?php echo $row['c_dev'] ?>" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_learnl1[]" value="<?php echo $row['c_learnl'] ?>" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_learn1[]" value="<?php echo $row['c_learn'] ?>" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
	...
	$result = $conn->query("SELECT * FROM marakez WHERE myear=".$the_year) or die($conn->error());
	?>
	<table class="table cen2">
		<thead class="thead1">
			<th class="cen2">اعداد طلاب التحفيظ</th>
		...
		while ($row = $result->fetch_assoc()): ?>
			<tr class="me">
				<?php $x = $t * 5;?>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_student[]" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_devl[]" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_dev[]" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_learnl[]" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="sm1"><input type="" tabindex="<?php echo $x; $x--?>" name="c_learn[]" class="form-control cen2" ondrop="return false;" onpaste="return false;" onkeypress="return event.charCode>=48 && event.charCode<=57" autocomplete="off"></td>
				<td class="right1"><input type="hidden" name="c_markaz[]" value="<?php echo $row['ID']; ?>"><?php echo $row['mname']; ?></td>
				<?php $t++; ?>
			</tr>
		<?php endwhile; ?>
